        ...
        return (
            <div className="my">
                ...
                <div className="icon headbox">
                    ...
                    <div className="arrow-box" onClick={me.openPage.bind(me,me._tk ? `/myprofile` : `/signin`)}>
                        <i className="icon" />
                    </div>
                    <div className="user-info">
                        <div className="nick">
                            {
                              me._tk?(my.name||'我的昵称'):'您还未登录'
                            }
                            {
                                me._tk?<div className="icon" onClick={me.openPage.bind(me,`/mymsg`)}><span></span></div>:null
                            }
                        </div>
                        {
                            me._tk ? <div className="account">ID:{my.id}</div> : <div className="account" onClick={me.openPage.bind(me,'/signin')}>点此登录</div>
                        }
                    </div>
                </div>
                <div className="thinner-border clearboth"></div>
                <ul className="link-list">
                    <li onClick={me.openPage.bind(me,me._tk ? `/mycoupons` : `/signin`)}>
                    ...
                    <li onClick={me.openPage.bind(me,me._tk ? `/shophot` : `/signin`)}>
